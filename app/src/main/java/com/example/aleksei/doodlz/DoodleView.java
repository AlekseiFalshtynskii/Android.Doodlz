...
public class DoodleView extends View {
    ...
    public void saveImage() {
        ...
        if (location != null) {
            toastShow(R.string.message_saved);
        } else {
            toastShow(R.string.message_error_saving);
        }
    }
    ...
    public void printImage() {
        if (PrintHelper.systemSupportsPrint()) {
            ...
            toastShow(R.string.message_error_printing);
        }
    }

    private void toastShow(int stringId) {
        Toast toast = Toast.makeText(getContext(), stringId, Toast.LENGTH_SHORT);
